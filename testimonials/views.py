...
class AddTestimonialView(LoginRequiredMixin, CreateView):
    """
    creates and adds a user testimonial
    to be approved for the testimonila page
    """
...
class EditTestimonialView(UserPassesTestMixin, UpdateView):
    ...
    def test_func(self):
        ...
        return (
            ...
            self.request.user == testimonial.user.user
        )
...
class SuperUserCheck(UserPassesTestMixin, View):
    """
    A CBV mixin to prevent access from users that are not
    superusers From https://stackoverflow.com/questions/67351312/
